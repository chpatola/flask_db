...
users_course = "SELECT U.USERNAME,U.FIRSTNAME,U.LASTNAME,U.PHONE,U.BORNYEAR FROM COURSEENROLMENTSTEST E" \
    " LEFT JOIN USERSTEST U ON U.USERNAME = E.USER_ID WHERE E.COURSE_ID = :id"